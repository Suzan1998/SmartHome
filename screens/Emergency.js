...
const Emergency =(route)=>{
    ...
    return (
        <View style={styles.root}>
            ...
            <Card style={{width:370,height:80, backgroundColor:'#197fff',justifyContent:'center', alignSelf:'center'}}>
                 <Text style={{fontSize:30,color:'white',alignSelf:'center', marginTop:25}}>Call Civil Defense(102)</Text>
             </Card>
             <Card style={{width:370,height:290,margin:3, backgroundColor:'#197fff',justifyContent:'center', alignSelf:'center'}}>
